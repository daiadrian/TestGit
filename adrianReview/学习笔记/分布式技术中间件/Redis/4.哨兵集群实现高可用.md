...
![async-replication-data-lose-case](C:\Adrian\学习笔记\分布式技术中间件\Redis\images\4.哨兵模式1.png)
...
![redis-cluster-split-brain](C:\Adrian\学习笔记\分布式技术中间件\Redis\images\4.哨兵模式2.png)
